...
import {
  ...
  IonBackButton,
  IonInput,
  IonModal, IonIcon, IonLabel, IonListHeader, IonRow, IonGrid, IonCol, IonBadge, IonList, IonNote, IonFooter, IonItemSliding, IonItemOptions, IonItemOption } from '@ionic/angular/standalone';
...
seleccionarPresentacion(producto: any) {
  ...
  console.log('a enviar a api', this.ventaFinal);
